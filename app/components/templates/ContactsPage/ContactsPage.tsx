...
import MailSvg from '@/app/components/elements/MailSvg/MailSvg'
import FeedbackForm from '@/app/components/modules/FeedbackForm/FeedbackForm'
          ...
          {isWholesaleBuyersPage ? (
            ...
            <ul className={`${styles.contacts__list} ${darkModeClass}`}>
              <li className={styles.contacts__list__title}>
                <h3 className={darkModeClass}>Магазин ...</h3>
              </li>
              ...
              <li className={`${styles.contacts__list__item} ${darkModeClass}`}>
                ...
                <span className={styles.contacts__list__item__mail}>
                  {!isMobile560 && <MailSvg />}{' '}
                  <span>info@shoplayout.com.ru</span>
                </span>
              </li>
            </ul>
          )}
